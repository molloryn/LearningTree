...
Could not load file or assembly 'AsterixDecoder, Version=2.0.0.0, Culture=neutral, PublicKeyToken=null'. The system cannot find the file specified.
  ...
  - Stack Trace:    at System.Reflection.RuntimeModule.GetTypes(RuntimeModule module)
   ...
   at Monica.Core.Modules.ModuleControllers.PostConfigureServices(IServiceCollection services) in D:\Code\Monica\Monica.Core\Modules\Controllers.cs:line 27
   at Monica.Core.Module.MoModule`3.<ConvertToRegisterRequest>b__8_2(ModuleRegisterContextWrapperForServices`1 context) in D:\Code\Monica\Monica.Core\Module\MoModule.cs:line 82
   at Monica.Core.Module.Interfaces.MoModuleGuide`3.<>c__DisplayClass13_0.<PostConfigureServices>b__0(ModuleRegisterContext registerContext) in D:\Code\Monica\Monica.Core\Module\Interfaces\MoModuleGuide.cs:line 278
   at Monica.Core.Module.MoModuleRegisterCentre.RegisterServices(WebApplicationBuilder builder) in D:\Code\Monica\Monica.Core\Module\MoModuleRegisterCentre.cs:line 239
   at Monica.Core.Module.Exceptions.ModuleErrorUtil.RaiseModuleErrors() in D:\Code\Monica\Monica.Core\Module\Exceptions\ModuleErrorUtil.cs:line 257
   at Monica.Core.Module.MoModuleRegisterCentre.RegisterServices(WebApplicationBuilder builder) in D:\Code\Monica\Monica.Core\Module\MoModuleRegisterCentre.cs:line 251
   at Monica.Core.Module.BuilderWrapper.WebApplicationBuilderExtensions.MoBuild(WebApplicationBuilder builder) in D:\Code\Monica\Monica.Core\Module\BuilderWrapper\WebApplicationBuilderExtensions.cs:line 57
